...
RESULTS_DIR=$HOME/SequiasHistoricasLLM/results/sbach_test
CIENA_LLM_MODEL="qwen2.5:3b-instruct-q4_K_M"
...
poetry run python 05_launch_ciena.py work fastest-no-summary detect
